 ...
 *
 *
 * @version $Id: G2GuiResources.java,v 1.54 2003/11/05 17:44:18 vnc Exp $
 */
public class G2GuiResources {
    ...
    */
    ...
    private static void createImageRegistry() {
        ...
        String[] buttonFiles = { "preferences", "statistics", "console", "transfer", "search", "server", "messages", "news" };
...
Revision 1.54  2003/11/05 17:44:18  vnc
small rename of transfer icon
