...
public class G2GuiResources {
    ...
    private static void createImageRegistry() {
        ...
        ImageData source =
            ImageDescriptor.createFromFile( G2Gui.class, "images/mld_logo_48x48.gif" ).getImageData();
        ...
        for ( int i = 0; i < buttonNames.length; i++ ) {
            ...
            imageRegistry.put( buttonNames[ i ] + "ButtonSmallActive",
                               createActive( buttonFiles[ i ] + "-16.png" ) );
            imageRegistry.put( buttonNames[ i ] + "ButtonSmallTitlebar",
        ...
        imageRegistry.put( "MessagesButtonSmallTrans",
                           ImageDescriptor.createFromFile( MainTab.class, "images/messages-16.gif" ) );
        imageRegistry.put( "MessagesButtonSmallTransBW",
                           ImageDescriptor.createFromFile( MainTab.class, "images/messages-16-bw.gif" ) );
        imageRegistry.put( "DownArrow", createTrans( "down.png" ) );
        imageRegistry.put( "UpArrow", createTrans( "up.png" ) );
        imageRegistry.put( "UpArrowBlue",
                           ImageDescriptor.createFromFile( MainTab.class, "images/up_blue.gif" ) );
    ...
    private static Image createTrans( String filename, Color color ) {
        return createTransparentImage( ImageDescriptor.createFromFile( MainTab.class, "images/" + filename )
                                                      .createImage(), color );
    }
