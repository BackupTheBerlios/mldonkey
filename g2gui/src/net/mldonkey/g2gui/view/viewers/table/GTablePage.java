 ...
 *
 * @version $Id: GTablePage.java,v 1.1 2003/10/31 10:42:47 lemmster Exp $
 *
 */
public class GTablePage extends GPage {
    ...
    public GTablePage(Composite parent, CoreCommunication core) {
        this.core = core;
    }
