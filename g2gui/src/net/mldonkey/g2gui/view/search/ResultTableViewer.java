 ...
 * ResultTableViewer
 *
 * @version $Id: ResultTableViewer.java,v 1.1 2003/10/21 17:00:45 lemmster Exp $ 
 *
 */
public class ResultTableViewer extends OurTableViewer {
	private ResultTableMenuListener resultTableMenuListener;
	private CTabItem cTabItem;
	private MouseListener aMouseListener;

	public ResultTableViewer( Composite aComposite, CoreCommunication aCore, CTabItem aCTabItem, MouseListener aMouseListener ) {
		super( aComposite, aCore );
		this.cTabItem = aCTabItem;
		this.aMouseListener = aMouseListener;

		this.tableColumns = new String[] { "SR_NETWORK",
											"SR_NAME",
											"SR_SIZE",
											"SR_FORMAT",
											"SR_MEDIA",
		...
		this.tableWidth = new int[] { 58, 300, 65, 45, 50, 70 };
    
		this.tableAlign = new int[] { SWT.LEFT, SWT.LEFT, SWT.RIGHT, 
		...
		this.labelProvider = new ResultTableLabelProvider();
		this.tableSorter = new ResultTableSorter();
		this.menuListener = new ResultTableMenuListener( core, cTabItem );
	...
	public ResultTableMenuListener getMenuListener() {
		return this.resultTableMenuListener;
	}
