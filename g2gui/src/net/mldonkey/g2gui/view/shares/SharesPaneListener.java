 ...
 * SharesPaneListener
 *
 * @version $Id: SharesPaneListener.java,v 1.1 2004/01/22 21:28:04 psy Exp $
 *
 */
public class SharesPaneListener extends SashViewFrameListener {
    /**
     * @param gViewer
     * @param core
     * @param aSashForm
     * @param aControl
     */
    public SharesPaneListener(SashViewFrame sashViewFrame) {
        super(sashViewFrame);
        setBestFit();
