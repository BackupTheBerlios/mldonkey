 ...
 * UploadTableViewer
 *
 * @version $Id: SharesTableView.java,v 1.1 2004/01/22 21:28:04 psy Exp $
 *
 */
public class SharesTableView extends GTableView implements Observer {
     ...
     */
    public SharesTableView(ViewFrame viewFrame) {
        super(viewFrame);
    ...
    public void update(Observable o, Object obj) {
        ...
        if (System.currentTimeMillis() > (lastTimeStamp + 5000)) {
            ...
            viewFrame.updateCLabelTextInGuiThread(G2GuiResources.getString("ST_SHARES") + ": " +
                clientStats.getNumOfShare() + " (" +
                RegExp.calcStringSize(clientStats.getTotalUp()) + " " +
				G2GuiResources.getString("ST_UPLOADED") + ")");
        }
    }
    ...
    public class UploadContentProvider extends GTableContentProvider implements Observer {
         ...
         */
        public UploadContentProvider(SharesTableView uTableViewer) {
            super(uTableViewer);
        }
    ...
    public class UploadLabelProvider extends GTableLabelProvider {
        public UploadLabelProvider(SharesTableView uTableViewer) {
            super(uTableViewer);
        }
        ...
        public String getColumnText(Object element, int columnIndex) {
            ...
            case SharesTableView.BYTES:
                return info.getUploadedString();

            case SharesTableView.REQUESTS:
                return "" + info.getNumOfQueriesForFile();

            case SharesTableView.NAME:
                return info.getName();
    ...
    public class UploadTableSorter extends GSorter {
        public UploadTableSorter(SharesTableView uTableViewer) {
            super(uTableViewer);
        }
