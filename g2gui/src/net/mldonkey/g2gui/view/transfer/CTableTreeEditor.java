...
* </pre></code>
*/
public class CTableTreeEditor extends CControlEditor {
...
*
*/
public CTableTreeEditor (TableTree tableTree) {
	...
	treeListener = new TreeListener () {
		final Runnable runnable = new Runnable() {
			public void run() {
				if (CTableTreeEditor.this.tableTree == null 
				|| CTableTreeEditor.this.tableTree.isDisposed() || editor == null) return;
				resize();
		...
		public void treeCollapsed(TreeEvent e) {
			...
			Display display = CTableTreeEditor.this.tableTree.getDisplay();
