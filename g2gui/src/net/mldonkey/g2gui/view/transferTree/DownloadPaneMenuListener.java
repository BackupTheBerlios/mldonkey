 ...
 *
 *
 * @version $Id: DownloadPaneMenuListener.java,v 1.3 2003/09/18 12:12:23 lemmster Exp $
 *
 */
public class DownloadPaneMenuListener implements IMenuListener {
    private static String[] ExtensionNames = { G2GuiResources.getString( "TT_DOWNLOAD_FILTER_AUDIO" ),
    											 G2GuiResources.getString( "TT_DOWNLOAD_FILTER_VIDEO" ),
    											 G2GuiResources.getString( "TT_DOWNLOAD_FILTER_PICTURE" ) };

    private static String[] AudioExtensions = { "aac", "ape", "au", "flac",
    											 "mpc", "mp2", "mp3", "mp4",
    											 "wav", "ogg", "wma" };
 
    private static String[] VideoExtensions = { "avi", "mpg", "mpeg", "ram",
    											  "rm", "asf", "vob", "divx",
    											  "vivo", "ogm", "mov", "wmv" };
 
    private static String[] ArchiveExtensions = { "gz", "zip", "ace", "rar", "tar", "tgz", "bz2" };
 
    private static String[] CDImageExtensions = { "ccd", "sub", "cue", "bin", "iso",
    											    "nrg", "img", "bwa", "bwi", "bws",
    											    "bwt", "mds", "mdf" };
 
    private static String[] PictureExtensions = { "jpg", "jpeg", "bmp", "gif", "tif", "tiff", "png" };
 
    private static String[][] Extensions = { AudioExtensions, VideoExtensions, ArchiveExtensions,
    ...
    public void fillContextMenu( IMenuManager menuManager ) {
        ...
        MenuManager columnsSubMenu =
            new MenuManager( G2GuiResources.getString( "TT_DOWNLOAD_MENU_COLUMNS" ) );
    ...
    public class FileStateFilter extends ViewerFilter {
         ...
         * @param parentElement DOCUMENT ME!
...
Revision 1.3  2003/09/18 12:12:23  lemmster
checkstyle
