 ...
 *
 *
 * @version $Id: FileDetailDialog.java,v 1.32 2003/09/18 12:12:23 lemmster Exp $
 *
 */
public class FileDetailDialog implements Observer, DisposeListener {
    ...
    private void createFileTransferGroup( Shell parent ) {
        ...
        clTransferred =
            createLine( fileTransfer, G2GuiResources.getString( "TT_DOWNLOAD_FD_TRANSFERRED" ), false );
        clRelativeAvail =
            createLine( fileTransfer, G2GuiResources.getString( "TT_DOWNLOAD_FD_REL_AVAIL" ), false );
    ...
    private void createChunkGroup( Shell parent, String text, NetworkInfo networkInfo ) {
        ...
        ChunkCanvas chunkCanvas =
            new ChunkCanvas( chunkGroup, SWT.NO_BACKGROUND, null, fileInfo, networkInfo );
            ...
            fileCancelButton.addSelectionListener( new SelectionAdapter() {
                    public void widgetSelected( SelectionEvent s ) {
                        MessageBox reallyCancel =
                                                   new MessageBox( fileCancelButton.getShell(),
...
Revision 1.32  2003/09/18 12:12:23  lemmster
checkstyle
