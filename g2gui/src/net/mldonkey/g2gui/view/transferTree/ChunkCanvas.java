 ...
 *
 *
 * @version $Id: ChunkCanvas.java,v 1.21 2003/09/18 12:12:23 lemmster Exp $
 *
 */
public class ChunkCanvas extends Canvas implements Observer {
        ...
        if ( image != null ) {
            ...
            try {
                ...
                System.out.println( "e.width: " + e.width + " e.height: " + e.height + " bw: "
                                    + bufferImage.getBounds().width + " bh: "
     ...
     * DOCUMENT ME!
     *
     * @param srcWidth DOCUMENT ME!
     * @param srcHeight DOCUMENT ME!
     * @param bufferGC DOCUMENT ME!
     */
